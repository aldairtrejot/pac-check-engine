...
use App\Http\Controllers\Pac\PacFilterOptionsController;
use App\Http\Controllers\Empleado\EmpleadoCatalogOptionsController;
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/pac/filter-options', [PacFilterOptionsController::class, 'options'])->name('pac.filter-options');
